<template>
    <div class="admin-club-container">
                ...
                <a-row>
                    <a-col :span="8" style="margin-bottom: 10px;">
                        <a-row>
                            ...
                            <a-col :span="17"><a-input placeholder="Nhập tên"
        ...
        <a-table bordered :columns="columns" :data-source="listItem.data" :pagination="listItem.pagination"
            ...
            <div slot="color" slot-scope="value">
                <div :style="`width: 100px;height: 60px;background-color:${value}`"></div>
            </div>
        ...
        <a-modal title="Thông tin size" :visible="modalOpen" :footer="null" width="1400px" @cancel="() => this.modalOpen = false">
...
export default {
    ...
    methods: {
        ...mapActions({
            getListItem: "color/getListItem",
            deleteItem: "color/deleteItem",
        }),
