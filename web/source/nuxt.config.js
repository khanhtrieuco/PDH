...
module.exports = {
  ...
  proxy: {
    ...
    '/users-permissions/roles' : { target: hostapi },
    '/users-permissions/email-templates' : { target: hostapi },
    '/users-permissions/advanced' : { target: hostapi },
    '/email/settings' : { target: hostapi },
